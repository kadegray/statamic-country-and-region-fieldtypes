...
return [
    ...
    "CH-LU" => "Luzern",
    "CH-NE" => "Neuchâtel",
    "CH-NW" => "Unterwalden nid dem Wald",
    "CH-OW" => "Unterwalden ob dem Wald",
    "CH-SG" => "Sankt Gallen",
    "CH-SH" => "Schaffhausen",
    "CH-SO" => "Solothurn",
    "CH-SZ" => "Schwyz",
    ...
    "ES-CE" => "Ceuta",
    "ES-CL" => "Kastília-León",
    "ES-CM" => "Kastília-La Mancha",
    "ES-CN" => "Kanárske ostrovy",
    "ES-CO" => "Córdoba",
    "ES-CR" => "Ciudad Real",
    "ES-CS" => "Castelló*",
    ...
    "HN-VA" => "Valle",
    "HN-YO" => "Yoro",
    "HR-01" => "Záhrebská župa",
    "HR-02" => "Krapinsko-zagorská župa",
    "HR-03" => "Sisacko-moslavinská župa",
    "HR-04" => "Karlovecká župa",
    "HR-05" => "Varaždínska župa",
    "HR-06" => "Koprivnicko-križevatská župa",
    "HR-07" => "Bjelovarsko-bilogorská župa",
    "HR-08" => "Prímorsko-gorskokotarská župa",
    "HR-09" => "Licko-senjská župa",
    "HR-10" => "Viroviticko-podrávska župa",
    "HR-11" => "Požecko-slavónska župa",
    "HR-12" => "Brodsko-posávska župa",
    "HR-13" => "Zadarská župa",
    "HR-14" => "Osijecko-baranjská župa",
    "HR-15" => "Šibenicko-kninská župa",
    "HR-16" => "Vukovarsko-sriemska župa",
    "HR-17" => "Splitsko-dalmatínska župa",
    "HR-18" => "Istrijská župa",
    "HR-19" => "Dubrovnícko-neretvianska župa",
    "HR-20" => "Medzimurská župa",
    "HR-21" => "Grad Zagreb",
    "HT-AR" => "Artibonite",
    "HT-CE" => "Centre",
    "HT-GA" => "Grandans",
    ...
    "HU-BC" => "Békešská Čaba",
    "HU-BE" => "Békešská župa",
    "HU-BK" => "Báčsko-malokumánska župa",
    "HU-BU" => "Budapest",
    "HU-BZ" => "Boršodsko-abovsko-zemplínska župa",
    "HU-CS" => "Čongrádska župa",
    "HU-DE" => "Debrecín",
    "HU-DU" => "Dunaújváros",
    "HU-EG" => "Jáger",
    "HU-ER" => "Érd",
    "HU-FE" => "(Stolično)Belehradská župa",
    "HU-GS" => "Rábsko-mošonsko-šopronská župa",
    "HU-GY" => "Ráb",
    "HU-HB" => "Hajducko-bihárska župa",
    "HU-HE" => "Hevešská župa",
    "HU-HV" => "Hódmezővásárhely",
    "HU-JN" => "Jasovsko-veľkokumánsko-solnocká župa",
    "HU-KE" => "Komárňansko-ostrihomská župa",
    "HU-KM" => "Kecskemét",
    "HU-KV" => "Kapošvár",
    "HU-MI" => "Miškovec",
    "HU-NK" => "Veľká Kaniža",
    "HU-NO" => "Novohradská župa",
    "HU-NY" => "Níreďháza",
    "HU-PE" => "Peštianska župa",
    "HU-PS" => "Pécs",
    "HU-SD" => "Segedín",
    "HU-SF" => "Stoličný Belehrad",
    "HU-SH" => "Szombathely",
    "HU-SK" => "Szolnok",
    "HU-SN" => "Šopron",
    "HU-SO" => "Šomodská župa",
    "HU-SS" => "Szekszárd",
    "HU-ST" => "Šalgov-Tarjany [Šalgotarján]",
    "HU-SZ" => "Sabolčsko-satmársko-berežská župa",
    "HU-TB" => "Tatabánya",
    "HU-TO" => "Tolnianska župa",
    "HU-VA" => "Vašská župa (Železná župa)",
    "HU-VE" => "Veszprém",
    "HU-VM" => "Veszprém",
    "HU-ZA" => "Zalianska župa",
    "HU-ZE" => "Zalaegerszeg",
    "ID-AC" => "Aceh",
    "ID-BA" => "Bali",
    ...
    "RU-KAM" => "Kamčatský kraj",
    "RU-KB" => "Kabardino-Balkarskaja Respublika",
    "RU-KC" => "Karačajsko-Čerkesko",
    ...
    "RU-NIZ" => "Nižnonovgorodská oblasť",
    ...
    "US-AL" => "Alabama",
    "US-AR" => "Arkansas",
    "US-AS" => "Americká Samoa",
    "US-AZ" => "Arizona",
    "US-CA" => "Kalifornia",
    "US-CO" => "Colorado",
    "US-CT" => "Connecticut",
    "US-DC" => "Federálny dištrikt Kolumbia",
    "US-DE" => "Delaware",
    "US-FL" => "Florida",
    "US-GA" => "Georgia",
    "US-GU" => "Guam",
    ...
    "US-MN" => "Minnesota",
    "US-MO" => "Missouri",
    "US-MP" => "Spoločenstvo ostrovov Severné Mariány",
    "US-MS" => "Mississippi",
    "US-MT" => "Montana",
    ...
    "US-OR" => "Oregon",
    "US-PA" => "Pensylvánia",
    "US-PR" => "Portorické spoločenstvo",
    "US-RI" => "Rhode Island",
    "US-SC" => "Južná Karolína",
    "US-SD" => "Južná Dakota",
    "US-TN" => "Tennessee",
    "US-TX" => "Texas",
    "US-UM" => "Menšie odľahlé ostrovy Spojených štátov",
    "US-UT" => "Utah",
    "US-VA" => "Virgínia",
