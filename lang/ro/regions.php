...
return [
    ...
    "BR-BA" => "Bahia",
    "BR-CE" => "Ceará",
    "BR-DF" => "Districtul federal Brazilian",
    ...
    "KH-8" => "Kandaal",
    "KH-9" => "Kaoh Kong",
    "KI-G" => "Insulele Gilbert",
    "KI-L" => "Insulele Line",
    "KI-P" => "Insulele Phoenix",
    "KM-A" => "Andjouân",
    "KM-G" => "Andjazîdja",
    "KM-M" => "Mohéli",
    ...
    "US-AL" => "Alabama",
    "US-AR" => "Arkansas",
    "US-AS" => "Samoa americană",
    "US-AZ" => "Arizona",
    "US-CA" => "California",
    "US-CO" => "Colorado",
    "US-CT" => "Connecticut",
    "US-DC" => "Districtul Columbiei",
    "US-DE" => "Delaware",
    "US-FL" => "Florida",
    "US-GA" => "Georgia",
    "US-GU" => "Guam",
    ...
    "US-MN" => "Minnesota",
    "US-MO" => "Missouri",
    "US-MP" => "Insulele Mariane de nord",
    "US-MS" => "Mississippi",
    "US-MT" => "Montana",
    ...
    "US-TN" => "Tennessee",
    "US-TX" => "Texas",
    "US-UM" => "Insulele de Coasta ale Statelor Unite",
    "US-UT" => "Utah",
    "US-VA" => "Virginia",
