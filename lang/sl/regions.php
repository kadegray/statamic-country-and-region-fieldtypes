...
return [
    ...
    "AR-A" => "Salta",
    "AR-B" => "Buenos Aires",
    "AR-C" => "Avtonomno mesto Buenos Aires",
    "AR-D" => "San Luis",
    "AR-E" => "Entre Ríos",
    "AR-F" => "La Rioja",
    ...
    "AZ-ZAQ" => "Zaqatala",
    "AZ-ZAR" => "Zərdab",
    "BA-BIH" => "Federacija Bosne in Hercegovine",
    "BA-BRC" => "Okraj Brčko",
    "BA-SRP" => "Republika srbska",
    "BB-01" => "Christ Church",
    "BB-02" => "Saint Andrew",
    "BB-03" => "Saint George",
    "BB-04" => "Saint James",
    ...
    "CZ-20B" => "Příbram",
    "CZ-20C" => "Rakovnik",
    "CZ-31" => "Južnočeški okraj",
    "CZ-311" => "Češke Budjejovice",
    "CZ-312" => "Češki Krumlov",
    "CZ-313" => "Jindrichov Hradec",
    "CZ-314" => "Pisek",
    "CZ-315" => "Prachatice",
    "CZ-316" => "Strakonice",
    "CZ-317" => "Tabor",
    "CZ-32" => "Plzenski okraj",
    "CZ-321" => "Domažlice",
    "CZ-322" => "Klatovy",
    "CZ-323" => "Plzeň-město",
    "CZ-324" => "Plzeň-jih",
    ...
    "ES-CC" => "Caceres",
    "ES-CE" => "Ceuta",
    "ES-CL" => "Kastilija in Leon",
    "ES-CM" => "Kastilija-La Mancha",
    "ES-CN" => "Kanarski otoki",
    "ES-CO" => "Cordoba",
    "ES-CR" => "Ciudad Real",
    "ES-CS" => "Castelló*",
    ...
    "ES-M" => "Madrid",
    "ES-MA" => "Malaga",
    "ES-MC" => "Murcijska regija",
    "ES-MD" => "Madridska skupnost",
    "ES-ML" => "Melilla",
    "ES-MU" => "Murcia",
    "ES-NA" => "Nafarroa*",
    ...
    "FR-PF" => "Francoska polinezija",
    "FR-PM" => "Saint-Pierre-et-Miquelon",
    "FR-RE" => "La Réunion",
    "FR-TF" => "Francoska južna ozemlja",
    ...
    "GB-ANS" => "Angus",
    "GB-BAS" => "Bath in North East Somerset",
    "GB-BBD" => "Blackburn in Darwen",
    ...
    "GB-ERY" => "East Riding v Yorkshiru",
    "GB-ESS" => "Essex",
    "GB-ESX" => "East Sussex",
    "GB-FAL" => "Falkirk",
    "GB-FIF" => "Fife",
    ...
    "HN-VA" => "Valle",
    "HN-YO" => "Yoro",
    "HR-01" => "Zagrebška županija",
    "HR-02" => "Krapinsko-zagorska županija",
    "HR-03" => "Siško-moslavška županija",
    "HR-04" => "Karlovška županija",
    "HR-05" => "Varaždinska županija",
    "HR-06" => "Koprivniško-križevška županija",
    "HR-07" => "Bjelovarsko-bilogorska županija",
    "HR-08" => "Primorsko-goranska županija",
    "HR-09" => "Liško-senjska županija",
    "HR-10" => "Virovitiško-podravska županija",
    "HR-11" => "Požeško-slavonska županija",
    "HR-12" => "Brodsko-posavska županija",
    "HR-13" => "Zadarska županija",
    "HR-14" => "Osješko-baranjska županija",
    "HR-15" => "Šibeniško-kninska županija",
    "HR-16" => "Vukovarsko-sremska županija",
    "HR-17" => "Splitsko-dalmatinska županija",
    "HR-18" => "Istrska županija",
    "HR-19" => "Dubrovniško-neretvanska županija",
    ...
    "HU-ER" => "Erd",
    "HU-FE" => "Fejer",
    "HU-GS" => "Györ-Mošon-Šopron",
    "HU-GY" => "Györ",
    "HU-HB" => "Hajdu-Bihar",
    "HU-HE" => "Heveš",
    "HU-HV" => "Hodmezövasarhely",
    "HU-JN" => "Jasz-Nagykun-Szolnok",
    "HU-KE" => "Komarom-Estergom",
    "HU-KM" => "Kecskemet",
    "HU-KV" => "Kapošvar",
    "HU-MI" => "Miškolc",
    "HU-NK" => "Nagykanizsa",
    ...
    "PK-PB" => "Pandžab",
    "PK-SD" => "Sindh",
    "PL-02" => "Spodnješlezijsko",
    "PL-04" => "Kujavsko-pomorjansko",
    "PL-06" => "Lublinsko",
    "PL-08" => "Lubuško",
    "PL-10" => "Lodzsko",
    "PL-12" => "Malopoljsko",
    ...
    "PL-24" => "Šlezijsko",
    "PL-26" => "Svetokriško",
    "PL-28" => "Varminsko-Mazursko",
    "PL-30" => "Velikopoljsko",
    "PL-32" => "Zahodnopomorjansko",
    "PS-BTH" => "Bethlehem",
    ...
    "RO-VS" => "Vaslui",
    "RS-00" => "Beograd",
    "RS-01" => "Severnobaški okraj",
    "RS-02" => "Osrednjebanatski okraj",
    "RS-03" => "Severnobanatski okraj",
    "RS-04" => "Južnobanatski okraj",
    "RS-05" => "Zahodnobaški okraj",
    "RS-06" => "Južnobaški okraj",
    "RS-07" => "Sremski okraj",
    "RS-08" => "Mačvanski okraj",
    "RS-09" => "Kolubarski okraj",
    "RS-10" => "Podonavski okraj",
    "RS-11" => "Braničevski okraj",
    "RS-12" => "Šumadijski okraj",
    "RS-13" => "Pomoravski okraj",
    "RS-14" => "Borski okraj",
    "RS-15" => "Zaječarski okraj",
    "RS-16" => "Zlatiborski okraj",
    "RS-17" => "Moraviški okraj",
    "RS-18" => "Raški okraj",
    "RS-19" => "Rasinski okraj",
    "RS-20" => "Nišavski okraj",
    "RS-21" => "Topliški okraj",
    "RS-22" => "Pirotski okraj",
    "RS-23" => "Jablaniški okraj",
    "RS-24" => "Pčinjski okraj",
    "RS-25" => "Kosovski okraj",
    "RS-26" => "Peški okraj",
    "RS-27" => "Prizrenski okraj",
    "RS-28" => "Kosovsko-Mitroviški okraj",
    "RS-29" => "Kosovsko-Pomoravski okraj",
    ...
    "RU-KLU" => "Kaluško okrožje",
    "RU-KO" => "Komijska republika",
    ...
    "RU-NIZ" => "Nižnonovgorodsko okrožje",
    ...
    "SI-212" => "Mirna",
    "SI-213" => "Ankaran",
    "SK-BC" => "Banskobistriški okraj",
    "SK-BL" => "Bratislavski okraj",
    "SK-KI" => "Košiški okraj",
    "SK-NI" => "Nitranski okraj",
    "SK-PV" => "Prešovski okraj",
    "SK-TA" => "Trnavski okraj",
    "SK-TC" => "Trenčinski okraj",
    "SK-ZI" => "Žilinski okraj",
    "SL-E" => "Eastern",
    "SL-N" => "Northern",
    "SL-NW" => "North Western",
    "SL-S" => "Southern",
    ...
    "US-TN" => "Tennessee",
    "US-TX" => "Teksas",
    "US-UM" => "manjši otoki Združenih držav Amerike",
    "US-UT" => "Juta",
    "US-VA" => "Virginia",
