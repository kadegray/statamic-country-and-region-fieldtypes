...
return [
    ...
    "NL-ZH" => "Zuid-Holland",
    "NO-03" => "Oslon lääni",
    "NO-11" => "Rogalandin lääni",
    "NO-15" => "Møre ja Romsdalin lääni",
    "NO-18" => "Nordlandin lääni",
    ...
    "US-AL" => "Alabama",
    "US-AR" => "Arkansas",
    "US-AS" => "Amerikan Samoa",
    "US-AZ" => "Arizona",
    "US-CA" => "Kalifornia",
    "US-CO" => "Colorado",
    "US-CT" => "Connecticut",
    "US-DC" => "Kolumbian piiri",
    "US-DE" => "Delaware",
    "US-FL" => "Florida",
    "US-GA" => "Georgia",
    "US-GU" => "Guam",
    ...
    "US-TN" => "Tennessee",
    "US-TX" => "Texas",
    "US-UM" => "Yhdysvaltain pienet erillissaaret",
    "US-UT" => "Utah",
    "US-VA" => "Virginia",
