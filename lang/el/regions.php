...
return [
    ...
    "AZ-ZAQ" => "Zaqatala",
    "AZ-ZAR" => "Zərdab",
    "BA-BIH" => "Ομοσπονδία Βοσνίας και Ερζεγοβίνης",
    ...
    "BF-ZON" => "Zondoma",
    "BF-ZOU" => "Zoundwéogo",
    "BG-01" => "Μπλαγκόεβγκραντ",
    "BG-02" => "Μπουργκάς",
    "BG-03" => "Βάρνα",
    "BG-04" => "Βελίκο Τίρνοβο",
    "BG-05" => "Vidin",
    "BG-06" => "Vratsa",
    "BG-07" => "Γκάμπροβο",
    "BG-08" => "Dobrich",
    ...
    "FR-PF" => "Γαλλική Πολυνησία",
    "FR-PM" => "Άγιος Πέτρος και Μικελόν",
    "FR-RE" => "La Réunion",
    "FR-TF" => "Γαλλικά νότια εδάφη",
    ...
    "US-AL" => "Αλαμπάμα",
    "US-AR" => "Άρκανσω",
    "US-AS" => "Αμερικανική Σαμόα",
    "US-AZ" => "Arizona",
    "US-CA" => "California",
    "US-CO" => "Colorado",
    "US-CT" => "Κονεκτικάτ",
    "US-DC" => "Περιφέρεια της Κολούμπια",
    "US-DE" => "Ντελαουέρ",
    "US-FL" => "Florida",
    "US-GA" => "Γεωργία",
    "US-GU" => "Γκουάμ",
    ...
    "US-TN" => "Τεννεσσί",
    "US-TX" => "Τέξας",
    "US-UM" => "Απομακρυσμένες Νησίδες των Ηνωμένων Πολιτειών",
    "US-UT" => "Γιούτα",
    "US-VA" => "Βιρτζίνια",
