...
return [
    "AD-02" => "Canillo közösség",
    "AD-03" => "Encamp (közösség)",
    "AD-04" => "La Massana",
    "AD-05" => "Ordino",
    ...
    "AZ-BEY" => "Beylagan",
    "AZ-BIL" => "Bilasuvar",
    "AZ-CAB" => "Jabrayil Rayon",
    "AZ-CAL" => "Cəlilabad",
    "AZ-CUL" => "Culfa",
    "AZ-DAS" => "Daşkəsən",
    "AZ-FUZ" => "Füzuli",
    "AZ-GA" => "Ganja, Azerbajian",
    "AZ-GAD" => "Gədəbəy",
    "AZ-GOR" => "Goranboy",
    "AZ-GOY" => "Goychay (city)",
    "AZ-GYG" => "Göygöl",
    ...
    "CZ-513" => "Liberec",
    "CZ-514" => "Semily",
    "CZ-52" => "Hradec Králové-i kerület",
    "CZ-521" => "Királyvárad",
    "CZ-522" => "Jičín",
    "CZ-523" => "Náchod",
    ...
    "CZ-64" => "Dél-Morva kerület",
    "CZ-641" => "Blansko",
    "CZ-642" => "Brno-City District",
    "CZ-643" => "Brno-Country District",
    "CZ-644" => "Břeclav",
    "CZ-645" => "Hodonín",
    "CZ-646" => "Vyškov",
    "CZ-647" => "Znojmo",
    ...
    "ES-CC" => "Cáceres",
    "ES-CE" => "Ceuta",
    "ES-CL" => "Kasztília és León",
    "ES-CM" => "Kasztília-La Mancha",
    "ES-CN" => "Canarias",
    "ES-CO" => "Córdoba",
    "ES-CR" => "Ciudad Real",
    "ES-CS" => "Castelló*",
    ...
    "FR-62" => "Pas-de-Calais",
    "FR-63" => "Puy-de-Dôme",
    "FR-64" => "Atlanti-pireneusok",
    "FR-65" => "Hautes-Pyrénées",
    "FR-66" => "Keleti-pireneusok",
    "FR-67" => "Bas-Rhin",
    "FR-68" => "Haut-Rhin",
    "FR-69" => "Rajna",
    "FR-70" => "Haute-Saône",
    ...
    "FR-BRE" => "Bretagne",
    "FR-CP" => "Clipperton-sziget",
    "FR-CVL" => "Centre-Val de Loire",
    "FR-GES" => "Grand-Est",
    "FR-GF" => "Guyane (française)",
    "FR-GP" => "Guadeloupe",
    "FR-HDF" => "Hauts-de-France",
    "FR-IDF" => "Île-de-France Régió",
    "FR-MF" => "Saint-Martin",
    "FR-MQ" => "Martinique",
    ...
    "GB-BDF" => "Bedford",
    "GB-BDG" => "Barking and Dagenham kerület",
    "GB-BEN" => "Brent",
    "GB-BEX" => "Bexley",
    "GB-BFS" => "Belfast City",
    ...
    "GB-CLD" => "Metropolitan Borough of Calderdale",
    ...
    "GB-HAL" => "Halton",
    "GB-HAM" => "Hampshire",
    "GB-HAV" => "Havering kerület",
    "GB-HCK" => "Hackney",
    "GB-HEF" => "Herefordshire",
    "GB-HIL" => "Hillingdon",
    "GB-HLD" => "Highland",
    "GB-HMF" => "London Borough of Hammersmith and Fulham",
    "GB-HNS" => "Hounslow",
    "GB-HPL" => "Hartlepool",
    ...
    "GB-WAR" => "Warwickshire",
    "GB-WBK" => "Nyugat-Berkshire",
    "GB-WDU" => "Nyugat-Dunbartonshire",
    "GB-WFT" => "Waltham Forest",
    "GB-WGN" => "Wigan",
    "GB-WIL" => "Wiltshire",
    "GB-WKF" => "Wakefield",
    "GB-WLL" => "Walsall",
    "GB-WLN" => "Nyugat-Lothian",
    "GB-WLS" => "Wales [Cymru GB-CYM]",
    "GB-WLV" => "Wolverhampton",
    "GB-WND" => "Wandsworth",
    "GB-WNM" => "Windsor és Maidenhead",
    "GB-WOK" => "Wokingham",
    ...
    "GB-WSM" => "Westminster",
    "GB-WSX" => "Nyugat-Sussex",
    "GB-YOR" => "York",
    "GB-ZET" => "Shetland szigetek",
    "GD-01" => "Saint Andrew",
    "GD-02" => "Saint David",
    "GD-03" => "Saint George",
    "GD-04" => "Saint John",
    ...
    "IL-TA" => "Tall Abīb",
    "IL-Z" => "Ash Shamālī",
    "IN-AN" => "Andamán- és Nikobár-szigetek",
    "IN-AP" => "Ándhra Pradés",
    ...
    "IR-10" => "Isfahan Povince",
    "IR-11" => "Sīstān va Balūchestān",
    "IR-12" => "Kordestān Province",
    "IR-13" => "Hamadān",
    ...
    "LY-JI" => "Al Jafārah",
    "LY-JU" => "Al Jufrah (kerület)",
    "LY-KF" => "Al Kufrah (kerület)",
    "LY-MB" => "Al Margub",
    "LY-MI" => "Mişrātah",
    "LY-MJ" => "Al Marj",
    "LY-MQ" => "Murzuq",
    ...
    "SI-212" => "Mirna",
    "SI-213" => "Ankaran",
    "SK-BC" => "Besztercebányai kerület",
    "SK-BL" => "Pozsonyi kerület",
    "SK-KI" => "Kassai kerület",
    "SK-NI" => "Nyitrai kerület",
    ...
    "TL-VI" => "Vikeke",
    "TM-A" => "Ahal",
    "TM-B" => "Délkelet-Európa (Balkán-félsziget)",
    "TM-D" => "Daşoguz",
    "TM-L" => "Lebap",
    "TM-M" => "Mary",
    "TM-S" => "Aşgabat",
    ...
    "TR-80" => "Osmaniye",
    "TR-81" => "Düzce",
    "TT-ARI" => "The Royal Borough of Arima",
    "TT-CHA" => "Chaguanas",
    ...
    "US-TN" => "Tennessee",
    "US-TX" => "Texas",
    "US-UM" => "Az Amerikai Egyesült Államok lakatlan külbirtokai",
    "US-UT" => "Utah",
    "US-VA" => "Virginia",
    ...
    "VE-U" => "Yaracuy",
    "VE-V" => "Zulia",
    "VE-W" => "Federal Dependencies of Venezuela",
    "VE-X" => "La Guaira",
    "VE-Y" => "Delta Amacuro",
