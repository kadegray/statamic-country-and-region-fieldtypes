...
return [
    ...
    "GB-CCG" => "Causeway Coast dan Glens",
    ...
    "GB-DND" => "Dundee City",
    "GB-DOR" => "Dorset",
    "GB-DRS" => "Derry dan Strabane",
    "GB-DUD" => "Dudley",
    "GB-DUR" => "Durham, County",
    "GB-EAL" => "Ealing",
    "GB-EAY" => "East Ayrshire",
    "GB-EDH" => "Kota Edinburgh",
    ...
    "GB-KWL" => "Knowsley",
    "GB-LAN" => "Lancashire",
    "GB-LBC" => "Lisburn dan Castlereagh",
    "GB-LBH" => "Lambeth",
    "GB-LCE" => "Leicester",
    "GB-LDS" => "Leeds",
    ...
    "GB-MDW" => "Medway",
    "GB-MEA" => "Antrim Tengah dan Timur",
    ...
    "MA-09" => "Souss-Massa",
    "MA-10" => "Kata Benda Guelmim-Oued (parsial EH)",
    "MA-11" => "Laâyoune-Sakia El Hamra (parsial EH)",
    "MA-12" => "Dakhla-Oued Ed-Dahab (EH)",
    "MA-AGD" => "Agadir-Ida-Ou-Tanane",
    "MA-AOU" => "Aousserd (EH)",
    "MA-ASZ" => "Assa-Zag (parsial EH)",
    "MA-AZI" => "Azilal",
    "MA-BEM" => "Béni Mellal",
    "MA-BER" => "Berkane",
    "MA-BES" => "Benslimane",
    ...
    "US-TN" => "Tennessee",
    "US-TX" => "Texas",
    "US-UM" => "Kepulauan Terluar Kecil Amerika Serikat",
    "US-UT" => "Utah",
    "US-VA" => "Virginia",
