...
return [
    ...
    "CL-ML" => "Maule",
    "CL-NB" => "Ñuble",
    "CL-RM" => "Santiago - hovedstadsregionen",
    "CL-TA" => "Tarapaca",
    "CL-VS" => "Valparaiso",
    "CM-AD" => "Adamaoua",
    "CM-CE" => "Centre",
    ...
    "ES-M" => "Madrid",
    "ES-MA" => "Malaga",
    "ES-MC" => "Regionen Murcia",
    "ES-MD" => "Regionen Madrid",
    "ES-ML" => "Melilla",
    "ES-MU" => "Murcia",
    "ES-NA" => "Nafarroa*",
    ...
    "FR-PM" => "Sankt-Pierre-et-Miquelon",
    "FR-RE" => "La Réunion",
    ...
    "GB-BNE" => "Barnet",
    "GB-BNH" => "Brighton og Hove",
    "GB-BNS" => "Barnsley",
    "GB-BOL" => "Bolton",
    "GB-BPL" => "Blackpool",
    "GB-BRC" => "Bracknell Skov",
    "GB-BRD" => "Bradford",
    "GB-BRY" => "Bromley",
    "GB-BST" => "Bristol, Byen",
    "GB-BUR" => "Bury",
    ...
    "GB-CHE" => "Cheshire Øst",
    "GB-CHW" => "Cheshire Vest og Chester",
    "GB-CLD" => "Calderdale",
    ...
    "GB-ERY" => "East Riding af Yorkshire",
    "GB-ESS" => "Essex",
    "GB-ESX" => "East Sussex",
    "GB-FAL" => "Falkirk",
    "GB-FIF" => "Fife",
    ...
    "GB-PKN" => "Perth og Kinross",
    "GB-PLY" => "Plymouth",
    "GB-POR" => "Portsmouth",
    "GB-POW" => "Powys",
    "GB-PTE" => "Peterborough",
    "GB-RCC" => "Redcar og Cleveland",
    "GB-RCH" => "Rochdale",
    ...
    "GY-EB" => "Øst Berbice-Corentyne",
    "GY-ES" => "Essequiboøerne-Vestdemerara",
    "GY-MA" => "Mahaica-Berbice",
    "GY-PM" => "Pomeroon-Supenaam",
    "GY-PT" => "Potaro-Siparuni",
    "GY-UD" => "Øvre Demerara-Berbice",
    "GY-UT" => "Øvre Takutu-Upper Essequibo",
    "HN-AT" => "Atlántida",
    "HN-CH" => "Choluteca",
    "HN-CL" => "Colón",
    "HN-CM" => "Comayagua",
    ...
    "JM-09" => "Hanover",
    "JM-10" => "Westmoreland",
    "JM-11" => "Sankt Elizabeth",
    "JM-12" => "Manchester",
    "JM-13" => "Clarendon",
    "JM-14" => "Sankt Catherine",
    "JO-AJ" => "‘Ajlūn",
    "JO-AM" => "Al ‘A̅şimah",
    "JO-AQ" => "Al ‘Aqabah",
    "JO-AT" => "Aţ Ţafīlah",
    ...
    "KN-02" => "Sankt Anne Sandy Point",
    "KN-03" => "Sankt George Basseterre",
    "KN-04" => "Sankt George Gingerland",
    "KN-05" => "Sankt James Windward",
    "KN-06" => "Sankt John Capisterre",
    "KN-07" => "Sankt John Figtree",
    "KN-08" => "Sankt Mary Cayon",
    "KN-09" => "Sankt Paul Capisterre",
    "KN-10" => "Sankt Paul Charlestown",
    "KN-11" => "Sankt Peter Basseterre",
    "KN-12" => "Sankt Thomas Lowland",
    "KN-13" => "Sankt Thomas Midtø",
    ...
    "NO-18" => "Nordland",
    "NO-21" => "Svalbard (Arktisk region)",
    "NO-22" => "Jan Mayen (Arktisk region)",
    "NO-30" => "Viken",
    "NO-34" => "Innlandet",
    ...
    "SB-CE" => "Central",
    "SB-CH" => "Choiseul",
    "SB-CT" => "Hovedstadsområdet (Honiara)",
    "SB-GU" => "Guadalcanal",
    "SB-IS" => "Isabel",
    "SB-MK" => "Makira-Ulawa",
    "SB-ML" => "Malaita",
