...
return [
    ...
    "BS-BP" => "Black Point",
    "BS-BY" => "Berry Islands",
    "BS-CE" => "Trung Eleuthera",
    "BS-CI" => "Đảo Cat",
    "BS-CK" => "Đảo Crooked và Long Cay",
    "BS-CO" => "Trung Abaco",
    "BS-CS" => "Trung Andros",
    ...
    "DM-10" => "Saint Paul",
    "DM-11" => "Saint Peter",
    "DO-01" => "Vùng Quốc Gia (Santo Domingo)",
    "DO-02" => "Azua",
    "DO-03" => "Baoruco",
    "DO-04" => "Barahona",
    "DO-05" => "Dajabón",
    ...
    "GB-BNE" => "Barnet",
    "GB-BNH" => "Brighton và Hove",
    "GB-BNS" => "Barnsley",
    "GB-BOL" => "Bolton",
    "GB-BPL" => "Blackpool",
    "GB-BRC" => "Rừng Bracknell",
    "GB-BRD" => "Bradford",
    "GB-BRY" => "Bromley",
    "GB-BST" => "Thành Phố Bristol",
    "GB-BUR" => "Bury",
    ...
    "GB-DER" => "Derby",
    "GB-DEV" => "Devon",
    "GB-DGY" => "Dumfries và Galloway",
    "GB-DNC" => "Doncaster",
    "GB-DND" => "Thành Phố Dundee",
    "GB-DOR" => "Dorset",
    "GB-DRS" => "Derry and Strabane",
    "GB-DUD" => "Dudley",
    "GB-DUR" => "Durham, County",
    "GB-EAL" => "Ealing",
    "GB-EAY" => "Đông Ayrshire",
    "GB-EDH" => "Thành Phố Edinburgh",
    "GB-EDU" => "Đông Dunbartonshire",
    "GB-ELN" => "Đông Lothian",
    "GB-ELS" => "Eilean Siar",
    "GB-ENF" => "Enfield",
    "GB-ENG" => "England",
    "GB-ERW" => "Đông Renfrewshire",
    "GB-ERY" => "Đông Riding của Yorkshire",
    "GB-ESS" => "Essex",
    "GB-ESX" => "Đông Sussex",
    "GB-FAL" => "Falkirk",
    "GB-FIF" => "Fife",
    ...
    "GB-ISL" => "Islington",
    "GB-IVC" => "Inverclyde",
    "GB-KEC" => "Kensington và Chelsea",
    "GB-KEN" => "Kent",
    "GB-KHL" => "Kingston upon Hull",
    "GB-KIR" => "Kirklees",
    "GB-KTT" => "Kingston bên sông Thames",
    "GB-KWL" => "Knowsley",
    "GB-LAN" => "Lancashire",
    ...
    "GB-NEL" => "Đông Bắc Lincolnshire",
    "GB-NET" => "Newcastle bên sông Tyne",
    "GB-NFK" => "Norfolk",
    "GB-NGM" => "Nottingham",
    "GB-NIR" => "Northern Ireland",
    "GB-NLK" => "Bắc Lanarkshire",
    "GB-NLN" => "Bắc Lincolnshire",
    ...
    "GB-NYK" => "Bắc Yorkshire",
    "GB-OLD" => "Oldham",
    "GB-ORK" => "Quần Đảo Orkney",
    "GB-OXF" => "Oxfordshire",
    "GB-PEM" => "Pembrokeshire [Sir Benfro GB-BNF]",
    "GB-PKN" => "Perth và Kinross",
    "GB-PLY" => "Plymouth",
    "GB-POR" => "Portsmouth",
    "GB-POW" => "Powys",
    "GB-PTE" => "Peterborough",
    "GB-RCC" => "Redcar và Cleveland",
    "GB-RCH" => "Rochdale",
    "GB-RCT" => "Rhondda Cynon Taff [Rhondda CynonTaf]",
    "GB-RDB" => "Redbridge",
    "GB-RDG" => "Reading",
    "GB-RFW" => "Renfrewshire",
    "GB-RIC" => "Richmond bên sông Thames",
    "GB-ROT" => "Rotherham",
    "GB-RUT" => "Rutland",
    "GB-SAW" => "Sandwell",
    "GB-SAY" => "Nam Ayrshire",
    ...
    "GB-SLF" => "Salford",
    "GB-SLG" => "Slough",
    "GB-SLK" => "Nam Lanarkshire",
    "GB-SND" => "Sunderland",
    "GB-SOL" => "Solihull",
    "GB-SOM" => "Somerset",
    "GB-SOS" => "Southend Bờ Biển",
    "GB-SRY" => "Surrey",
    "GB-STE" => "Stoke bên sông Trent",
    "GB-STG" => "Stirling",
    "GB-STH" => "Southampton",
    "GB-STN" => "Sutton",
    "GB-STS" => "Staffordshire",
    "GB-STT" => "Stockton bên sông Tees",
    "GB-STY" => "Nam Tyneside",
    "GB-SWA" => "Swansea [Abertawe GB-ATA]",
    "GB-SWD" => "Swindon",
    "GB-SWK" => "Southwark",
    "GB-TAM" => "Tameside",
    "GB-TFW" => "Telford và Wrekin",
    "GB-THR" => "Thurrock",
    "GB-TOB" => "Torbay",
    ...
    "GY-EB" => "Đông Berbice-Corentyne",
    "GY-ES" => "Quần Đảo Essequibo — Tây Demerara",
    "GY-MA" => "Mahaica-Berbice",
    "GY-PM" => "Pomeroon-Supenaam",
    "GY-PT" => "Potaro-Siparuni",
    "GY-UD" => "Demerara Trên — Berbice",
    "GY-UT" => "Takutu-Essequibo Trên",
    "HN-AT" => "Atlántida",
    "HN-CH" => "Choluteca",
    "HN-CL" => "Colón",
    "HN-CM" => "Comayagua",
    ...
    "HN-VA" => "Valle",
    "HN-YO" => "Yoro",
    "HR-01" => "Hạt Zagrebačka",
    "HR-02" => "Hạt Krapinsko-zagorska",
    "HR-03" => "Hạt Sisačko-moslavačka",
    "HR-04" => "Hạt Karlovačka",
    "HR-05" => "Hạt Varaždinska",
    "HR-06" => "Hạt Koprivničko-križevačka",
    "HR-07" => "Bjelovarsko-bilogorska županija",
    "HR-08" => "Hạt Primorsko-goranska",
    "HR-09" => "Hạt Ličko-senjska",
    "HR-10" => "Hạt Virovitičko-podravska",
    "HR-11" => "Hạt Požeško-slavonska",
    "HR-12" => "Hạt Brodsko-posavska",
    "HR-13" => "Hạt Zadarska",
    "HR-14" => "Hạt Osječko-baranjska",
    "HR-15" => "Hạt Šibensko-kninska",
    "HR-16" => "Hạt Vukovarsko-srijemska",
    "HR-17" => "Hạt Splitsko-dalmatinska",
    "HR-18" => "Hạt Istarska",
    "HR-19" => "Hạt Dubrovačko-neretvanska",
    "HR-20" => "Hạt Međimurska",
    "HR-21" => "Grad Zagreb",
    "HT-AR" => "Artibonite",
    "HT-CE" => "Centre",
    "HT-GA" => "Grandans",
    ...
    "IL-TA" => "Tall Abīb",
    "IL-Z" => "Ash Shamālī",
    "IN-AN" => "Quần Đảo Andaman và Nicobar",
    ...
    "KH-8" => "Kandaal",
    "KH-9" => "Kaoh Kong",
    "KI-G" => "Quần Đảo Gilbert",
    "KI-L" => "Quần Đảo Line",
    "KI-P" => "Quần Đảo Phoenix",
    "KM-A" => "Andjouân",
    "KM-G" => "Andjazîdja",
    "KM-M" => "Mohéli",
    ...
    "KZ-MAN" => "Miền Mangghystaū",
    "KZ-PAV" => "Miền Pavlodar",
    "KZ-SEV" => "Severo-Kazahstanskaja oblast'",
    "KZ-SHY" => "Shymkent",
    "KZ-VOS" => "Miền Shyghys Qazaqstan",
    ...
    "MD-SD" => "Șoldănești",
    "MD-SI" => "Sîngerei",
    "MD-SN" => "Vùng Lãnh Thổ Thống Nhất Stînga Nistrului",
    "MD-SO" => "Soroca",
    "MD-ST" => "Strășeni",
    "MD-SV" => "Ștefan Vodă",
    "MD-TA" => "Taraclia",
    ...
    "PG-MPM" => "Madang",
    "PG-MRL" => "Manus",
    "PG-NCD" => "Quận Thủ Đô Quốc Gia (Port Moresby)",
    "PG-NIK" => "Ireland Mới",
    "PG-NPP" => "Miền Bắc",
    "PG-NSB" => "Bougainville",
    "PG-SAN" => "West Sepik",
    ...
    "PH-14" => "Miền Tự Trị trong Muslim Mindanao (ARMM)",
    "PH-15" => "Miền Quản Trị Cordillera (CAR)",
    ...
    "RU-BA" => "Cộng Hoà Bashkortostan,",
    "RU-BEL" => "Belgorodskaja oblast'",
    "RU-BRY" => "Brjanskaja oblast'",
    "RU-BU" => "Burjatija, Respublika",
    "RU-CE" => "Cộng Hoà Chechenskaya",
    "RU-CHE" => "Miền Chelyabinskaya",
    "RU-CHU" => "Miền tự trị Chukotskiy",
    "RU-CU" => "Cộng Hoà Chuvashskaya",
    "RU-DA" => "Cộng Hoà Dagestan,",
    "RU-IN" => "Ingushetiya, Respublika",
    "RU-IRK" => "Irkutskaja oblast'",
    "RU-IVA" => "Ivanovskaja oblast'",
    "RU-KAM" => "Miền Kamchatskiy",
    "RU-KB" => "Kabardino-Balkarskaja Respublika",
    "RU-KC" => "Cộng Hoà Karachayevo-Cherkesskaya",
    ...
    "SB-CE" => "Miền Trung",
    "SB-CH" => "Choiseul",
    "SB-CT" => "Vùng Lãnh Thổ Thủ Đô (Honiara)",
    "SB-GU" => "Guadalcanal",
    "SB-IS" => "Isabel",
    "SB-MK" => "Makira-Ulawa",
    "SB-ML" => "Malaita",
    ...
    "SI-212" => "Mirna",
    "SI-213" => "Ankaran",
    "SK-BC" => "Miền Banskobystrický",
    "SK-BL" => "Miền Bratislavský",
    "SK-KI" => "Miền Košický",
    "SK-NI" => "Miền Nitriansky",
    "SK-PV" => "Miền Prešovský",
    "SK-TA" => "Miền Trnavský",
    "SK-TC" => "Miền Trenčiansky",
    "SK-ZI" => "Miền Žilinský",
    "SL-E" => "Miền Đông",
    "SL-N" => "Miền Bắc",
    "SL-NW" => "North Western",
    "SL-S" => "Nam Phương",
    "SL-W" => "Vùng Tây (Freetown)",
    "SM-01" => "Acquaviva",
    "SM-02" => "Chiesanuova",
    "SM-03" => "Domagnano",
    "SM-04" => "Faetano",
