...
return [
    ...
    "AR-A" => "Salta",
    "AR-B" => "Buenos Aires",
    "AR-C" => "Buenos Airesko Hiri Autonomoa",
    "AR-D" => "San Luis",
    "AR-E" => "Entre Ríos",
    "AR-F" => "La Rioja",
    ...
    "AT-8" => "Vorarlberg",
    "AT-9" => "Viena",
    "AU-ACT" => "Australiako Hiriburuaren Lurraldea",
    "AU-NSW" => "Hegoaldeko Gales Berria",
    "AU-NT" => "Ipar Lurraldea",
    "AU-QLD" => "Queensland",
    "AU-SA" => "Hego Australia",
    "AU-TAS" => "Tasmania",
    "AU-VIC" => "Victoria",
    "AU-WA" => "Mendebaldeko Australia",
    "AZ-ABS" => "Absheron",
    "AZ-AGA" => "Agstafa",
    "AZ-AGC" => "Aghjabadi",
    "AZ-AGM" => "Agdam",
    ...
    "AZ-ZAQ" => "Zaqatala",
    "AZ-ZAR" => "Zardab",
    "BA-BIH" => "Bosnia-Herzegovinako Federazioa",
    "BA-BRC" => "Brčko distrikt",
    "BA-SRP" => "Bosniako Serbiar Errepublika",
    "BB-01" => "Christ Church",
    "BB-02" => "Saint Andrew",
    "BB-03" => "Saint George",
    "BB-04" => "Saint James",
    ...
    "BS-EX" => "Exuma",
    "BS-FP" => "Freeport hiria",
    "BS-GC" => "Grand Cay",
    "BS-HI" => "Harbour uhartea",
    "BS-HT" => "Hope Town",
    "BS-IN" => "Inagua",
    "BS-LI" => "Long Island",
    "BS-MC" => "Mangrove Cay",
    ...
    "BZ-TOL" => "Toledo",
    "CA-AB" => "Alberta",
    "CA-BC" => "Columbia Britainiarra",
    "CA-MB" => "Manitoba",
    "CA-NB" => "Brunswick Berria",
    "CA-NL" => "Ternua eta Labrador",
    "CA-NS" => "Ezkozia Berria",
    "CA-NT" => "Ipar-mendebaldeko Lurraldeak",
    "CA-NU" => "Nunavut",
    "CA-ON" => "Ontario",
    ...
    "CL-ML" => "Maule",
    "CL-NB" => "Ñuble",
    "CL-RM" => "Santiagoko metropolitar eskualdea",
    "CL-TA" => "Tarapacá",
    "CL-VS" => "Valparaíso",
    "CM-AD" => "Adamaoua",
    "CM-CE" => "Centre",
    ...
    "CM-LT" => "Littoral",
    "CM-NO" => "Iparraldea",
    "CM-NW" => "Ipar-mendebaldea",
    "CM-OU" => "Mendebaldea",
    "CM-SU" => "Hegoaldea",
    "CM-SW" => "Hegomendebaldea",
    "CN-AH" => "Anhui Sheng",
    "CN-BJ" => "Beijing Shi",
    "CN-CQ" => "Chongqing Shi",
    "CN-FJ" => "Fujian Sheng",
    ...
    "US-AL" => "Alabama",
    "US-AR" => "Arkansas",
    "US-AS" => "Amerikar Samoa",
    "US-AZ" => "Arizona",
    "US-CA" => "California",
    "US-CO" => "Colorado",
    "US-CT" => "Connecticut",
    "US-DC" => "Columbiako Barrutia",
    "US-DE" => "Delaware",
    "US-FL" => "Florida",
    "US-GA" => "Georgia",
    "US-GU" => "Guam",
    ...
    "US-MN" => "Minnesota",
    "US-MO" => "Missouri",
    "US-MP" => "Iparraldeko Mariana Uharteak",
    "US-MS" => "Mississippi",
    "US-MT" => "Montana",
    "US-NC" => "Ipar Carolina",
    "US-ND" => "Ipar Dakota",
