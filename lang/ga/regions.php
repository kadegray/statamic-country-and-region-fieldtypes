...
return [
    ...
    "IE-RN" => "Ros Comáin",
    "IE-SO" => "Sligeach",
    "IE-TA" => "Tiobraid Áirainn",
    "IE-U" => "Ulster",
    "IE-WD" => "Port Láirge",
    "IE-WH" => "An Iarmhí",
    "IE-WW" => "Cill Mhaintáin",
    "IE-WX" => "Loch Garman",
    "IL-D" => "Al Janūbī",
    "IL-HA" => "H̱efa",
    "IL-JM" => "Al Quds",
    ...
    "US-TN" => "Tennessee",
    "US-TX" => "Texas",
    "US-UM" => "Mion-Oileáin Imeallacha S.A.M.",
    "US-UT" => "Utah",
    "US-VA" => "Virginia",
