...
return [
    ...
    "FR-PF" => "Franska pólýnesía",
    "FR-PM" => "Saint-Pierre-et-Miquelon",
    "FR-RE" => "La Réunion",
    "FR-TF" => "Frönsku suðurhafslandsvæðin",
    ...
    "NO-03" => "Osló",
    "NO-11" => "Rogaland",
    "NO-15" => "Mæri og Romsdal",
    "NO-18" => "Norðurland",
    "NO-21" => "Svalbarði (heimsskautasvæði)",
    "NO-22" => "Jan Mayen (heimsskautasvæði)",
    "NO-30" => "Viken",
    "NO-34" => "Innlandet",
    ...
    "US-TN" => "Tennessee",
    "US-TX" => "Texas",
    "US-UM" => "Ytri-smáeyjar Bandaríkjanna",
    "US-UT" => "Utah",
    "US-VA" => "Virginia",
