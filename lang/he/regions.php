...
return [
    ...
    "AD-04" => "לה מסאנה",
    "AD-05" => "אורדינו",
    "AD-06" => "סן ג׳וליה דה לוריה",
    "AD-07" => "אנדורה לה ולה",
    "AD-08" => "אסקלדס-אנגורדני",
    "AE-AJ" => "עג׳מאן",
    "AE-AZ" => "אבו דאבי",
    "AE-DU" => "דובאי",
    "AE-FU" => "פוג׳יירה",
    ...
    "FR-NOR" => "נורמנדי",
    "FR-OCC" => "אוקסיטניה",
    "FR-PAC" => "פרובאנס-אלפ-קוט ד׳אזור",
    "FR-PDL" => "פיי דה לה לואר",
    "FR-PF" => "פולינזיה הצרפתית",
    "FR-PM" => "סן-פייר ומיקלון",
    "FR-RE" => "ראוניון",
    "FR-TF" => "הארצות הדרומיות והאנטרקטיות של צרפת",
    "FR-WF" => "ואליס ופוטונה",
    "FR-YT" => "מיוט",
    "GA-1" => "Estuaire",
    "GA-2" => "Haut-Ogooué",
    ...
    "LY-DR" => "דרנה",
    "LY-GT" => "ע׳את",
    "LY-JA" => "אל־ג׳בל אל־אח׳דר",
    "LY-JG" => "אל־ג׳בל אל־ע׳רבי",
    "LY-JI" => "Al Jafārah",
    "LY-JU" => "אל־ג׳יפרה",
    "LY-KF" => "אל־כופרה",
    "LY-MB" => "אל־מורקוב",
    ...
    "LY-ZA" => "א־זאויה",
    "MA-01" => "טנג׳יר-תטואן-אל־חוקיימה",
    "MA-02" => "אוריינטל",
    "MA-03" => "פס-מקנס",
    "MA-04" => "רבאט-סלא-קניטרה",
    "MA-05" => "בני מלאל־חניפרה",
    "MA-06" => "קזבלנקה-סטאת",
    "MA-07" => "מרקש-סאפי",
    "MA-08" => "דרעה-תאפילאלת",
    "MA-09" => "סוס-מאסה",
    "MA-10" => "גולמים-ואד נון (חלקית בסהרה המערבית)",
    "MA-11" => "לעיון-סקיה אל־חמרה (חלקית בסהרה המערבית)",
    "MA-12" => "דאח׳לה-ואד א־ד׳הב (סהרה המערבית)",
    "MA-AGD" => "אגאדיר-אידא-ותנאן",
    "MA-AOU" => "אוסרד (סהרה המערבית)",
    "MA-ASZ" => "אסא-זאג (חלקית בסהרה המערבית)",
    "MA-AZI" => "אזילאל",
    "MA-BEM" => "בני מלאל",
    "MA-BER" => "ברכאן",
    "MA-BES" => "בן סלימן",
    "MA-BOD" => "בוג׳דור (סהרה המערבית)",
    "MA-BOM" => "בולמאן",
    "MA-BRR" => "ברשיד",
    "MA-CAS" => "קזבלנקה",
    "MA-CHE" => "שפשואן",
    "MA-CHI" => "שישאוה",
    "MA-CHT" => "אשתוקה-אית באהא",
    "MA-DRI" => "דריוש",
    "MA-ERR" => "א־רשידיה",
    "MA-ESI" => "א־סוירה",
    "MA-ESM" => "א־סמארה (חלקית בסהרה המערבית)",
    "MA-FAH" => "פחס-אנג׳רה",
    "MA-FES" => "פס",
    "MA-FIG" => "פגיג",
    "MA-FQH" => "פקיה בן סלאח",
    ...
    "MA-HOC" => "אל־חוסימה",
    "MA-IFR" => "איפראן",
    "MA-INE" => "אנזגאן-אית מלול",
    "MA-JDI" => "אל־ג׳דידה",
    "MA-JRA" => "ג׳ראדה",
    "MA-KEN" => "קונייטרה",
    "MA-KES" => "קלעת א־סראע׳ינה",
    "MA-KHE" => "Khémisset",
    "MA-KHN" => "Khénifra",
    "MA-KHO" => "ח׳וריבגה",
    "MA-LAA" => "לעיון (סהרה המערבית)",
    "MA-LAR" => "אל־עראש",
    "MA-MAR" => "מרקש",
    "MA-MDF" => "מדיק-פנידק",
    "MA-MED" => "מדיונה",
    ...
    "MA-NOU" => "נואסר",
    "MA-OUA" => "ורזאזאת",
    "MA-OUD" => "ואד א־ד׳הב (סהרה המערבית)",
    "MA-OUJ" => "וג׳דה-אנגאד",
    "MA-OUZ" => "וזאן",
    "MA-RAB" => "רבאט",
    "MA-REH" => "רחאמנה",
    ...
    "MA-SIK" => "סידי קאסם",
    "MA-SIL" => "סידי סלימאן",
    "MA-SKH" => "צח׳יראת תמארה",
    "MA-TAF" => "טרפאיה (חלקית בסהרה המערבית)",
    "MA-TAI" => "תאורירת",
    "MA-TAO" => "תאונאת",
    "MA-TAR" => "Taroudannt",
    "MA-TAT" => "טאטא",
    ...
    "MA-TIZ" => "תיזנית",
    "MA-TNG" => "טנג׳יר-אצילה",
    "MA-TNT" => "טאנטאן (חלקית בסהרה המערבית)",
    "MA-YUS" => "יוסופיה",
    "MA-ZAG" => "זאגורה",
    "MC-CL" => "לה קול",
    "MC-CO" => "לה קונדמין",
    ...
    "PK-BA" => "בלוצ׳יסטן",
    "PK-GB" => "גילגיט-בלטיסטן",
    "PK-IS" => "אסלאמאבאד",
    "PK-JK" => "Azad Jammu and Kashmir",
    "PK-KP" => "ח׳ייבר פח׳טונח׳ווה",
    "PK-PB" => "Punjab",
    "PK-SD" => "סינד",
    "PL-02" => "Dolnośląskie",
    ...
    "US-AL" => "אלבמה",
    "US-AR" => "ארקנסס",
    "US-AS" => "סמואה האמריקנית",
    "US-AZ" => "אריזונה",
    "US-CA" => "קליפורניה",
    "US-CO" => "קולורדו",
    "US-CT" => "קונטיקט",
    "US-DC" => "וושינגטון הבירה",
    "US-DE" => "דלאוור",
    "US-FL" => "פלורידה",
    "US-GA" => "ג׳ורג׳יה",
    "US-GU" => "גואם",
    ...
    "US-MN" => "מינסוטה",
    "US-MO" => "מיזורי",
    "US-MP" => "איי מריאנה הצפוניים",
    "US-MS" => "מיסיסיפי",
    "US-MT" => "Montana",
    "US-NC" => "קרוליינה הצפונית",
    "US-ND" => "דקוטה הצפונית",
    "US-NE" => "נברסקה",
    "US-NH" => "ניו המפשייר",
    "US-NJ" => "ניו ג׳רזי",
    ...
    "US-PR" => "פוארטו ריקו",
    "US-RI" => "רוד איילנד",
    "US-SC" => "קרוליינה הדרומית",
    "US-SD" => "דקוטה הדרומית",
    "US-TN" => "טנסי",
    "US-TX" => "טקסס",
    "US-UM" => "האיים המרוחקים הקטנים של ארצות הברית",
    "US-UT" => "יוטה",
    "US-VA" => "וירג׳יניה",
    ...
    "YE-TA" => "Tāʻizz",
    "ZA-EC" => "הכף המזרחי",
    "ZA-FS" => "המדינה החופשית",
    "ZA-GP" => "חאוטנג",
    "ZA-KZN" => "קוואזולו-נטאל",
    "ZA-LP" => "לימפופו",
    "ZA-MP" => "מפומלנגה",
    "ZA-NC" => "הכף הצפוני",
    "ZA-NW" => "North-West",
