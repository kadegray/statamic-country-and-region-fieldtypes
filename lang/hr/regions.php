...
return [
    ...
    "AT-8" => "Vorarlberg",
    "AT-9" => "Beč",
    "AU-ACT" => "Teritorij australskog glavnog grada",
    "AU-NSW" => "Novi Južni Wales",
    "AU-NT" => "Sjeverni teritorij",
    "AU-QLD" => "Queensland",
    ...
    "BD-G" => "Sylhet",
    "BD-H" => "Mymensingh",
    "BE-BRU" => "Regija glavnoga grada Bruxellesa",
    "BE-VAN" => "Antwerpen",
    "BE-VBR" => "Flamanski Brabant",
    "BE-VLG" => "Flamanska regija",
    "BE-VLI" => "Limburg",
    "BE-VOV" => "Istočna Flandrija",
    "BE-VWV" => "Zapadna Flandrija",
    "BE-WAL" => "Valonija, regija",
    "BE-WBR" => "Valonski Brabant",
    "BE-WHT" => "Hainaut",
    "BE-WLG" => "Liège",
    "BE-WLX" => "Luksemburg",
    "BE-WNA" => "Namur",
    ...
    "FR-GES" => "Grand-Est",
    "FR-GF" => "Gvajana (francuska)",
    "FR-GP" => "Gvadalupa",
    "FR-HDF" => "Hauts-de-France",
    "FR-IDF" => "Île-de-France",
    "FR-MF" => "Saint-Martin",
    "FR-MQ" => "Martinik",
    "FR-NAQ" => "Nova Akvitanija",
    "FR-NC" => "Nova Kaledonija",
    "FR-NOR" => "Normandija",
    "FR-OCC" => "Occitanie",
    "FR-PAC" => "Provansa-Alpe-Azurna obala",
    "FR-PDL" => "Zemlja Loire",
    "FR-PF" => "Francuska Polinezija",
    "FR-PM" => "Sveti Petar i Mikelon",
    "FR-RE" => "La Réunion",
    "FR-TF" => "Francuske južne zemlje",
    ...
    "GA-9" => "Woleu-Ntem",
    "GB-ABC" => "Armagh, Banbridge i Craigavon",
    "GB-ABD" => "Aberdeenshire",
    "GB-ABE" => "Aberdeen City",
    "GB-AGB" => "Argyll i Bute",
    "GB-AGY" => "Isle of Anglesey [Sir Ynys Môn GB-YNM]",
    "GB-AND" => "Ards i North Down",
    "GB-ANN" => "Antrim i Newtownabbey",
    "GB-ANS" => "Angus",
    "GB-BAS" => "Bath i North East Somerset",
    "GB-BBD" => "Blackburn s Darwenom",
    "GB-BCP" => "Bournemouth, Christchurch and Poole",
    "GB-BDF" => "Bedford",
    "GB-BDG" => "Barking i Dagenham",
    "GB-BEN" => "Brent",
    "GB-BEX" => "Bexley",
    "GB-BFS" => "Belfast City",
    ...
    "GB-CCG" => "Causeway Coast i Glens",
    "GB-CGN" => "Ceredigion [Sir Ceredigion]",
    "GB-CHE" => "Cheshire istočni",
    "GB-CHW" => "Cheshire zapadni i Chester",
    "GB-CLD" => "Calderdale",
    ...
    "GB-DER" => "Derby",
    "GB-DEV" => "Devon",
    "GB-DGY" => "Dumfries i Galloway",
    "GB-DNC" => "Doncaster",
    "GB-DND" => "Dundee City",
    "GB-DOR" => "Dorset",
    "GB-DRS" => "Derry i Strabane",
    "GB-DUD" => "Dudley",
    "GB-DUR" => "Durham, County",
    "GB-EAL" => "Ealing",
    "GB-EAY" => "Istočni Ayrshire",
    "GB-EDH" => "Edinburgh, grad",
    "GB-EDU" => "Istočni Dunbartonshire",
    "GB-ELN" => "Istočni Lothian",
    "GB-ELS" => "Eilean Siar",
    "GB-ENF" => "Enfield",
    "GB-ENG" => "Engleska",
    "GB-ERW" => "Istočni Renfrewshire",
    "GB-ERY" => "East Riding of Yorkshire",
    "GB-ESS" => "Essex",
    "GB-ESX" => "Istočni Sussex",
    "GB-FAL" => "Falkirk",
    "GB-FIF" => "Fife",
    "GB-FLN" => "Flintshire [Sir y Fflint GB-FFL]",
    "GB-FMO" => "Fermanagh i Omagh",
    "GB-GAT" => "Gateshead",
    "GB-GLG" => "Glasgow City",
    ...
    "GB-MDW" => "Medway",
    "GB-MEA" => "Srednji i istočni Antrim",
    ...
    "GB-MUL" => "Mid-Ulster",
    "GB-NAY" => "Sjeverni Ayrshire",
    "GB-NBL" => "Northumberland",
    "GB-NEL" => "Sjevernoistočni Lincolnshire",
    "GB-NET" => "Newcastle upon Tyne",
    "GB-NFK" => "Norfolk",
    "GB-NGM" => "Nottingham",
    "GB-NIR" => "Sjeverna Irska",
    "GB-NLK" => "Sjeverni Lanarkshire",
    "GB-NLN" => "Sjeverni Lincolnshire",
    "GB-NMD" => "Newry, Mourne i Down",
    ...
    "GB-NTY" => "Sjeverni Tyneside",
    "GB-NWM" => "Newham",
    "GB-NWP" => "Newport [Casnewydd GB-CNW]",
    "GB-NYK" => "Sjeverni Jorkšir",
    "GB-OLD" => "Oldham",
    "GB-ORK" => "Orkney otočje",
    "GB-OXF" => "Oxfordshire",
    "GB-PEM" => "Pembrokeshire [Sir Benfro GB-BNF]",
    "GB-PKN" => "Perth i Kinross",
    "GB-PLY" => "Plymouth",
    "GB-POR" => "Portsmouth",
    "GB-POW" => "Powys",
    "GB-PTE" => "Peterborough",
    "GB-RCC" => "Redcar i Cleveland",
    "GB-RCH" => "Rochdale",
    ...
    "GB-RUT" => "Rutland",
    "GB-SAW" => "Sandwell",
    "GB-SAY" => "Južni Ayrshire",
    "GB-SCB" => "Škotske granice",
    "GB-SCT" => "Škotska",
    "GB-SFK" => "Suffolk",
    "GB-SFT" => "Sefton",
    "GB-SGC" => "Južni Gloucestershire",
    "GB-SHF" => "Sheffield",
    "GB-SHN" => "St. Helens",
    "GB-SHR" => "Shropshire",
    "GB-SKP" => "Stockport",
    ...
    "GB-STY" => "Južni Tyneside",
    "GB-SWA" => "Swansea [Abertawe GB-ATA]",
    "GB-SWD" => "Swindon",
    "GB-SWK" => "Southwark",
    "GB-TAM" => "Tameside",
    "GB-TFW" => "Telford i Wrekin",
    "GB-THR" => "Thurrock",
    "GB-TOB" => "Torbay",
    ...
    "GB-WAR" => "Warwickshire",
    "GB-WBK" => "Zapadni Berkshire",
    "GB-WDU" => "Zapadni Dunbartonshire",
    "GB-WFT" => "Waltham Forest",
    "GB-WGN" => "Wigan",
    "GB-WIL" => "Wiltshire",
    "GB-WKF" => "Wakefield",
    "GB-WLL" => "Walsall",
    "GB-WLN" => "Zapadni Lothian",
    "GB-WLS" => "Wales [Cymru GB-CYM]",
    "GB-WLV" => "Wolverhampton",
    "GB-WND" => "Wandsworth",
    "GB-WNM" => "Windsor i Maidenhead",
    "GB-WOK" => "Wokingham",
    ...
    "GB-WSM" => "Westminster",
    "GB-WSX" => "Zapadni Sussex",
    "GB-YOR" => "York",
    "GB-ZET" => "Shetland otočje",
    "GD-01" => "Saint Andrew",
    "GD-02" => "Saint David",
    "GD-03" => "Saint George",
    "GD-04" => "Saint John",
    ...
    "LK-22" => "Matale",
    "LK-23" => "Nuwara Eliya",
    "LK-3" => "Južna provincija",
    "LK-31" => "Galle",
    "LK-32" => "Matara",
    "LK-33" => "Hambantota",
    "LK-4" => "Sjeverna provincija",
    "LK-41" => "Jaffna",
    "LK-42" => "Kilinochchi",
    "LK-43" => "Mannar",
    "LK-44" => "Vavuniya",
    ...
    "LK-61" => "Kurunegala",
    "LK-62" => "Puttalam",
    "LK-7" => "Sjeverna centralna provincija",
    "LK-71" => "Anuradhapura",
    "LK-72" => "Polonnaruwa",
    "LK-8" => "Uva Province",
    "LK-81" => "Badulla",
    ...
    "MU-SA" => "Savanne",
    "MV-00" => "Južni Ari atol",
    "MV-01" => "Addu City",
    "MV-02" => "Sjeverni Ari atol",
    "MV-03" => "Faadhippolhu",
    "MV-04" => "Felidhu Atoll",
    "MV-05" => "Hahdhunmathi",
    ...
    "NG-EK" => "Ekiti",
    "NG-EN" => "Enugu",
    "NG-FC" => "Teritorij glavnog grada Abuja",
    "NG-GO" => "Gombe",
    "NG-IM" => "Imo",
    "NG-JI" => "Jigawa",
    "NG-KD" => "Kaduna",
    ...
    "NL-GR" => "Groningen",
    "NL-LI" => "Limburg",
    "NL-NB" => "Sjeverni Brabant",
    "NL-NH" => "Sjeverna Nizozemska",
    "NL-OV" => "Overijssel",
    "NL-SX" => "Sint Maarten",
    "NL-UT" => "Utrecht",
    "NL-ZE" => "Zeeland",
    "NL-ZH" => "Južna Nizozemska",
    "NO-03" => "Oslo",
    "NO-11" => "Rogaland",
    "NO-15" => "Møre og Romsdal",
    "NO-18" => "Nordland",
    "NO-21" => "Svalbard (arktička regija)",
    "NO-22" => "Jan Mayen (arktička regija)",
    "NO-30" => "Viken",
    "NO-34" => "Innlandet",
    ...
    "PT-17" => "Vila Real",
    "PT-18" => "Viseu",
    "PT-20" => "Autonomna regija Azori",
    "PT-30" => "Autonomna regija Madeira",
    "PW-002" => "Aimeliik",
    "PW-004" => "Airai",
    "PW-010" => "Angaur",
    "PW-050" => "Hatohobei",
    ...
    "SD-DC" => "Centralni Darfur",
    "SD-DE" => "Istočni Darfur",
    "SD-DN" => "Sjeverni Darfur",
    "SD-DS" => "Južni Darfur",
    "SD-DW" => "Zapadni Darfur",
    "SD-GD" => "Gedaref",
    "SD-GK" => "Zapadni Kordofan",
    "SD-GZ" => "Gezira",
    "SD-KA" => "Kassala",
    "SD-KH" => "Khartoum",
    "SD-KN" => "Sjeverni Kordofan",
    "SD-KS" => "Južni Kordofan",
    "SD-NB" => "Blue Nile",
    "SD-NO" => "Northern",
    "SD-NR" => "River Nile",
    "SD-NW" => "White Nile",
    ...
    "US-MN" => "Minnesota",
    "US-MO" => "Missouri",
    "US-MP" => "Sjevernomarijanski otoci",
    "US-MS" => "Mississippi",
    "US-MT" => "Montana",
    ...
    "US-TN" => "Tennessee",
    "US-TX" => "Texas",
    "US-UM" => "Američki mali izvanjski otoci",
    "US-UT" => "Utah",
    "US-VA" => "Virginia",
    "US-VI" => "Djevičanski Otoci, SAD",
    "US-VT" => "Vermont",
    "US-WA" => "Washington",
    "US-WI" => "Wisconsin",
    "US-WV" => "Zapadna Virginia",
    "US-WY" => "Wyoming",
    "UY-AR" => "Artigas",
    "UY-CA" => "Canelones",
    "UY-CL" => "Cerro Largo",
