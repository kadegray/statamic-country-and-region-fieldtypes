...
return [
    ...
    "AT-8" => "Vorarlberg",
    "AT-9" => "Wien",
    "AU-ACT" => "Avustralya Başkent Bölgesi",
    ...
    "AZ-ZAQ" => "Zaqatala",
    "AZ-ZAR" => "Zərdab",
    "BA-BIH" => "Bosna Hersek Federasyonu",
    ...
    "BS-BP" => "Black Point",
    "BS-BY" => "Berry Adaları",
    "BS-CE" => "Merkez Eleuthera",
    "BS-CI" => "Cat Adası",
    "BS-CK" => "Crooked Island and Long Cay",
    "BS-CO" => "Merkez Abaco",
    "BS-CS" => "Merkez Andros",
    "BS-EG" => "Doğu Grand Bahama",
    "BS-EX" => "Exuma",
    ...
    "BS-RI" => "Ragged Adası",
    "BS-SA" => "Güney Andros",
    "BS-SE" => "Güney Eleuthera",
    "BS-SO" => "Güney Abaco",
    "BS-SS" => "San Salvador",
    "BS-SW" => "Spanish Wells",
    "BS-WG" => "Batı Grand Bahama",
    "BT-11" => "Paro",
    "BT-12" => "Chhukha",
    "BT-13" => "Haa",
    "BT-14" => "Samtse",
    ...
    "IL-TA" => "Tall Abīb",
    "IL-Z" => "Ash Shamālī",
    "IN-AN" => "Andaman ve Nicobar Adaları",
    ...
    "KH-8" => "Kandaal",
    "KH-9" => "Kaoh Kong",
    "KI-G" => "Gilbert Adaları",
    "KI-L" => "Line Adaları",
    "KI-P" => "Phoenix Adaları",
    "KM-A" => "Andjouân",
    "KM-G" => "Andjazîdja",
    "KM-M" => "Mohéli",
    ...
    "NZ-CAN" => "Canterbury",
    "NZ-CIT" => "Chatham Adaları Bölgesi",
    "NZ-GIS" => "Gisborne",
    "NZ-HKB" => "Hawke's Bay",
    "NZ-MBH" => "Marlborough",
    ...
    "RU-KAM" => "Kamçatka bölgesi",
    "RU-KB" => "Kabardino-Balkarskaja Respublika",
    "RU-KC" => "Karaçay-Çerkez Cumhuriyeti",
    ...
    "US-TN" => "Tennessee",
    "US-TX" => "Texas",
    "US-UM" => "Amerika Birleşik Devletleri Küçük Dış Adaları",
    "US-UT" => "Utah",
    "US-VA" => "Virginia",
