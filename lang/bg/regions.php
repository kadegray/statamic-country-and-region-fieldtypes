...
return [
    ...
    "FR-NC" => "Нова Каледония",
    "FR-NOR" => "Normandie",
    "FR-OCC" => "Occitanie",
    "FR-PAC" => "Provence-Alpes-Côte-d’Azur",
    "FR-PDL" => "Pays-de-la-Loire",
    "FR-PF" => "Френска Полинезия",
    ...
    "US-AL" => "Алабама",
    "US-AR" => "Араканзас",
    "US-AS" => "Американска Самоа",
    "US-AZ" => "Аризона",
    "US-CA" => "Калифорния",
    "US-CO" => "Колорадо",
    "US-CT" => "Кънектикът",
    "US-DC" => "Окръг Колумбия",
    "US-DE" => "Делауеър",
    "US-FL" => "Флорида",
    "US-GA" => "Грузия",
    "US-GU" => "Гуам",
    ...
    "US-MN" => "Минесота",
    "US-MO" => "Мисури",
    "US-MP" => "Северни Марианови Острови",
    "US-MS" => "Мисисипи",
    "US-MT" => "Монтана",
    ...
    "US-TN" => "Тенеси",
    "US-TX" => "Тексас",
    "US-UM" => "Малки Острови по крайбрежието на САЩ",
    "US-UT" => "Юта",
    "US-VA" => "Вирджиния",
